...
- `v0.39.1 - Study Plan Builder Polish` (in progress); previous: `v0.39.0 - Flexible Review Methods`
...
- The current version is `v0.39.1`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
