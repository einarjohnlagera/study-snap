...
- `v0.51.0 - Read-Path Performance Pass II` (In Progress); previous: `v0.50.4 - Exam Hub Discovery Polish` (Released)
...
- The current version is `v0.51.0`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
