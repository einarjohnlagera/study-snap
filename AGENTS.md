...
- `v0.41.1 - Review Set Detail Page: This-Set Study Dashboard` (in progress); previous: `v0.41.0 - Learning Companion (MVP)`
...
- The current version is `v0.41.1`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
