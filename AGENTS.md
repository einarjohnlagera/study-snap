...
- `v0.40.1 - Public Review Set Reachability` (in progress); previous: `v0.40.0 - Weekly Study Plan (Exam Countdown) + Primary Review Set`
...
- The current version is `v0.40.1`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
