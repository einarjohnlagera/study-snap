...
- `v0.37.2 - Plan Data Integrity Hotfix` (in progress); previous: `v0.37.1 - Native Memory Hotfix`
...
- The current version is `v0.37.2`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
