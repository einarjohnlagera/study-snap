...
- `v0.60.2 - Challenge Quiz Known-Limitations Cleanup` (In Progress); previous: `v0.60.1 - Challenge Quiz Fix Pass` (Released)
...
- The current version is `v0.60.2`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
