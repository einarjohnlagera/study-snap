...
- `v0.33.4 - Builder Surface Clarity` (in progress); previous: `v0.33.3 - Recursive Goal Adopt`
...
- The current version is `v0.33.4`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
