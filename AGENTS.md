...
- `v0.50.3 - Public Note Copy Flow & Related-Notes Consistency` (In Progress); previous: `v0.50.2 - Note Card Content Consistency` (Released)
...
- The current version is `v0.50.3`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
