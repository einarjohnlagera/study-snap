...
- `v0.54.1 - Public Note Copy Correctness Fixes` (In Progress); previous: `v0.54.0 - CPALE Exam Hub (Wave 2)` (Released)
...
- The current version is `v0.54.1`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
