...
- `v0.37.0 - Readiness-First Plans & Mastery Integrity` (in progress); previous: `v0.36.3 - OCR Fast-Follow: Messaging & Feedback`
...
- The current version is `v0.37.0`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
