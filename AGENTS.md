...
- `v0.36.3 - OCR Fast-Follow: Messaging & Feedback` (in progress); previous: `v0.36.2 - OCR Disable Hotfix`
...
- The current version is `v0.36.3`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
