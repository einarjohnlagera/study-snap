...
- `v0.64.0 - Add to Review Set` (In Progress); previous: `v0.63.0 - Ask Companion` (Released)
...
- The current version is `v0.64.0`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
