...
- `v0.58.0 - Reusable Practice Assets & the Return Loop` (In Progress); previous: `v0.57.0 - Practice-First Activation Onboarding` (Released)
...
- The current version is `v0.58.0`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
