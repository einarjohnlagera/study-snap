...
- `v0.60.3 - Challenge Quiz Shaping & Onboarding Coverage Capture` (In Progress); previous: `v0.60.2 - Challenge Quiz Known-Limitations Cleanup` (Released)
...
- The current version is `v0.60.3`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
