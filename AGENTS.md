...
- `v0.53.0 - SEO Discoverability: Exam Hub Depth & Organic Attribution` (In Progress); previous: `v0.52.1 - Early-Lifecycle Feedback Signals` (Released)
...
- The current version is `v0.53.0`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
