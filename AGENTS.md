...
- `v0.37.4 - Idle GC & Metaspace Ceiling Hotfix` (in progress); previous: `v0.37.3 - Study Plan Read-Path Memory Optimization`
...
- The current version is `v0.37.4`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
