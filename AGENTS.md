...
- `v0.43.0 - Companion Coach Experience` (in progress); previous: `v0.42.1 - Companion & Progress Polish`
...
- The current version is `v0.43.0`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
