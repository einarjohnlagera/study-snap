...
- `v0.47.0 - Conversion Audit Tier 4: Cleanup Batch` (in progress); previous: `v0.46.0 - Retention Depth: Due-Concepts Digest & Exam Pacing`
...
- The current version is `v0.47.0`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
