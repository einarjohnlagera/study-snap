...
- `v0.45.0 - Conversion Audit Tier 3 — Landing, Pricing & Discovery Polish` (in progress); previous: `v0.44.0 - Conversion & Retention Polish`
...
- The current version is `v0.45.1`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
