...
- `v0.23.1` (in progress); previous: `v0.23.0 - From Readers to Learners`
...
- The current version is `v0.23.1`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
