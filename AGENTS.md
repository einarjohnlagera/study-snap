...
- `v0.33.3 - Recursive Goal Adopt` (in progress); previous: `v0.33.2 - Plan Detail Redesign (view/edit split)`
...
- The current version is `v0.33.3`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
