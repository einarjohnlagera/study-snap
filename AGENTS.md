...
- `v0.38.0 - Read-Path Optimization Pass` (in progress); previous: `v0.37.4 - Idle GC & Metaspace Ceiling Hotfix`
...
- The current version is `v0.38.0`. Always keep `backend/pom.xml`, `frontend/package.json`, `RELEASES.md`, `README.md`, `ROADMAP.md`, `AGENTS.md`, and `CLAUDE.md` version references in sync when bumping a version.
