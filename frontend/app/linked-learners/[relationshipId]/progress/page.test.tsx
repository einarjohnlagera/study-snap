...
const activity = {
  ...
  engagement: { engagementMode: "CONSISTENCY", currentStreak: 3, longestStreak: 8, studyDaysThisWeek: 4 },
...
it("shows an explicit no-activity state instead of empty charts", async () => {
  jest.mocked(getLinkedLearnerProgress).mockResolvedValue({
    ...
    engagement: { engagementMode: "FOCUSED", currentStreak: 0, longestStreak: 0, studyDaysThisWeek: 0 },
