...
describe("PricingPage", () => {
  ...
  it("renders the Free, Plus, and Pro pricing layout", async () => {
    ...
    expect(screen.getAllByText("20 Quizzes / month")).not.toHaveLength(0);
    expect(screen.getByText("Practice more often with 100 quizzes each month")).toBeInTheDocument();
    expect(screen.getByText("Stay exam-ready with 200 quizzes each month")).toBeInTheDocument();
