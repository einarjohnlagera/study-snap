...
function CreatorImpactLinkCard() {
  return (
    <section aria-labelledby="your-impact-heading">
      <Card className="space-y-3 border-emerald-500/20 bg-emerald-500/5 p-4 sm:p-6">
        ...
        <Link href="/impact" className="inline-flex text-sm font-semibold text-emerald-700 hover:underline dark:text-emerald-300">
          View impact →
        </Link>
      </Card>
    </section>
