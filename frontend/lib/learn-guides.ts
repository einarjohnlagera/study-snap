...
export const learnGuideCategories: LearnGuideCategoryMeta[] = [
  ...
  },
  {
    ...
    description: "Guides for turning reviewer notes into practice questions and spotting weak areas before exam day.",
  },
  {
    key: "teachers",
    title: "For Teachers",
  ...
  },
  {
    key: "study-tips",
    title: "Study Tips",
    description: "Practical study-method guides about active recall, practice questions, and better review habits.",
  },
];
...
export const learnGuides: LearnGuide[] = [
  {
    ...
    intro:
      "A reviewer should make the next study session easier, not just repeat your original notes. The fastest way to get there is to shorten the lesson, pull out the key concepts, and use questions to check recall.",
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          "A reviewer becomes more useful when it leads directly into questions.",
