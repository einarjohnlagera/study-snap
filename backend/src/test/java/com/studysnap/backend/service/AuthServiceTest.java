...
class AuthServiceTest {
    ...
    void signup_tracksSignupAndVerificationEvents() {
        ...
        assertThat(savedUserCaptor.getValue().getIsPremium()).isFalse();
        assertThat(savedUserCaptor.getValue().getPremiumActivatedAt()).isNull();
        assertThat(savedUserCaptor.getValue().getPremiumExpiresAt()).isNull();
