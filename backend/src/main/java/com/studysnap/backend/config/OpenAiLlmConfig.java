...
public class OpenAiLlmConfig {
    ...
    public OpenAiPromptResources openAiPromptResources(
        ...
        String companionSystemPrompt = readResourceAsString(promptDir + "/companion-system.txt");
        String companionDeveloperPromptTemplate = readResourceAsString(promptDir + "/companion-developer.txt");
        ...
        String askCompanionSystemPrompt = readResourceAsString(promptDir + "/ask-companion-system.txt");
        String askCompanionDeveloperPromptTemplate = readResourceAsString(promptDir + "/ask-companion-developer.txt");
        ...
        return new OpenAiPromptResources(
                ...
                companionDeveloperPromptTemplate,
                ...
                askCompanionSystemPrompt,
                askCompanionDeveloperPromptTemplate,
