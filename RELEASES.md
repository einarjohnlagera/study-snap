...
A broader follow-up question — whether NoteLib should pursue organic-search investment beyond these vocabulary fixes into general (non-exam) subject content — is queued as a new Fable session (`docs/claude-prompt/public-library-seo-expansion-session-plan.md`), not yet run; see the Backlog Index.
