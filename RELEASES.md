...
- **"Build" icon collision with "Edit" (frontend).** Both actions resolved to the same `Pencil` icon. Added a distinct `build` icon (`Hammer`) to the shared `ActionIconName` set.
