...
- **App-feel polish batch (frontend, 5 items, no new backend entity/migration/endpoint).**
  ...
  - Sticky search/filter toolbar on Private Library and Public Library, using the same `sticky top-16 z-20` convention already used by 3 other surfaces.
