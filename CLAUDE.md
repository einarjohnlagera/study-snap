...
Current version: **v0.66.2 — Card Surface Token Fix** (In Progress, base branch `releases/v0.66.2`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
