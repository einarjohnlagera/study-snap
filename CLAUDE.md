...
Current version: **v0.64.0 — Add to Review Set** (In Progress, base branch `releases/v0.64.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
