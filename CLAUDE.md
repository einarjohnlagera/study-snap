...
Current version: **v0.60.2 — Challenge Quiz Known-Limitations Cleanup** (In Progress, base branch `releases/v0.60.2`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
