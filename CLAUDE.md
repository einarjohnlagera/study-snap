...
Current version: **v0.50.0 — Mobile Bottom Tab Bar** (In Progress, base branch `releases/v0.50.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
