...
Current version: **v0.52.1 — Early-Lifecycle Feedback Signals** (In Progress, base branch `releases/v0.52.1`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
