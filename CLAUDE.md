...
Current version: **v0.45.0 — Conversion Audit Tier 3 — Landing, Pricing & Discovery Polish** (in progress, base branch `releases/v0.45.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
