...
Current version: **v0.53.0 — Early-Lifecycle Feedback Signals** (In Progress, base branch `releases/v0.53.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
