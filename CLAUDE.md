...
Current version: **v0.67.0 — Explore Convergence** (In Progress, base branch `releases/v0.67.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
