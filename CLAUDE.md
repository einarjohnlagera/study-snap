...
Current version: **v0.47.0 — Conversion Audit Tier 4: Cleanup Batch** (in progress, base branch `releases/v0.47.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
