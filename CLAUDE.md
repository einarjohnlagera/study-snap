...
Current version: **v0.51.0 — Read-Path Performance Pass II** (In Progress, base branch `releases/v0.51.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
