...
Current version: **v0.44.0 — Conversion & Retention Polish** (Released, base branch `releases/v0.44.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
