...
Current version: **v0.45.1 — Study Plan Collection Fixes** (in progress, base branch `releases/v0.45.1`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
