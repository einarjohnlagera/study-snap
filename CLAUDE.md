...
Current version: **v0.66.0 — Challenge Quiz Result Clarity** (In Progress, base branch `releases/v0.66.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
