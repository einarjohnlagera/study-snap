...
Current version: **v0.67.1 — Explore Convergence Follow-ups** (In Progress, base branch `releases/v0.67.1`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
