...
Current version: **v0.55.0 — Result-Screen Companion Bridge** (In Progress, base branch `releases/v0.55.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
