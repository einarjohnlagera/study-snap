...
Current version: **v0.60.0 — Shared Official Pool Foundation** (In Progress, base branch `releases/v0.60.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
