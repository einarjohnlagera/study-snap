...
Current version: **v0.45.2 — Public Plan Preview Rollup Fix** (in progress, base branch `releases/v0.45.2`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
