...
Current version: **v0.46.0 — Retention Depth: Due-Concepts Digest & Exam Pacing** (in progress, base branch `releases/v0.46.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
