...
Current version: **v0.54.0 — CPALE Exam Hub (Wave 2)** (In Progress, base branch `releases/v0.54.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
