...
Current version: **v0.57.0 — Practice-First Activation Onboarding** (In Progress, base branch `releases/v0.57.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
