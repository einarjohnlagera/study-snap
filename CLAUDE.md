...
Current version: **v0.53.0 — SEO Discoverability: Exam Hub Depth & Organic Attribution** (In Progress, base branch `releases/v0.53.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
