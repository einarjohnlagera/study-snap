...
Current version: **v0.52.0 — Proactive In-App Feedback Prompts** (In Progress, base branch `releases/v0.52.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
