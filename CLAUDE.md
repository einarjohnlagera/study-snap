...
Current version: **v0.60.3 — Challenge Quiz Shaping & Onboarding Coverage Capture** (In Progress, base branch `releases/v0.60.3`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
