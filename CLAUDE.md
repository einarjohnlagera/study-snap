...
Current version: **v0.50.4 — Exam Hub Discovery Polish** (In Progress, base branch `releases/v0.50.4`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
