...
Current version: **v0.47.1 — V82 Migration Collision Hotfix** (Released, base branch `releases/v0.47.1`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
