...
Current version: **v0.51.1 — Dashboard Stage-1 Limit Wiring** (In Progress, base branch `releases/v0.51.1`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
