...
Current version: **v0.65.0 — Study Effectiveness Polish** (In Progress, base branch `releases/v0.65.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
