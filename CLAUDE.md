...
Current version: **v0.63.0 — Ask Companion** (In Progress, base branch `releases/v0.63.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
