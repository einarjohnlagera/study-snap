...
Current version: **v0.56.0 — Weak-Concept Explanation Links** (In Progress, base branch `releases/v0.56.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
