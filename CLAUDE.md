...
Current version: **v0.54.1 — Public Note Copy Correctness Fixes** (In Progress, base branch `releases/v0.54.1`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
