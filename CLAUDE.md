...
Current version: **v0.62.0 — Knowledge Impact** (In Progress, base branch `releases/v0.62.0`). Full shipped scope is in `RELEASES.md`; forward-looking scope and candidates are in `docs/product/ROADMAP.md`.
