...
- null or empty labels belong to a trailing **Not in a section** bucket. That display string is also the reserved name and cannot be authored as a real section, regardless of casing or surrounding whitespace.
