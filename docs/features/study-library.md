...
Library deletion UX:
- each Study Pack item in Library exposes a small overflow menu for destructive management (`Delete Study Pack`)
...
- Study Pack cards display:
  ...
  - tag chips
  - created date
  - primary open behavior by clicking card/title
  - quick-review secondary action
...
- dashboard Study Pack cards open via card/title click and remain non-destructive
