...
- helper text: `Note content cannot be edited after generating a Study Pack. You can still update the title, course/program, subject, and tags.` — Teacher/Admin authors get the longer variant naming audience, Domain Context, and Authored Depth as well
