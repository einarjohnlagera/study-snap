...
- Long Exam and Board Exam record fully-correct concepts on normal completion only when the effective recording concept exactly matches a source Study Pack's `keyConcepts`.
