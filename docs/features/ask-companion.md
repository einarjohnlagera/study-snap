...
Ask Companion is available only from authenticated collection detail pages. It is not reachable from Quick Review, Challenge Quiz, Long Exam, Board Exam, Interview Practice, or any other quiz/exam session screen.
