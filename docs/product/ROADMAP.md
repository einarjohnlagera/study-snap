...
`v0.42.0 - AI-assisted Companion authoring + regeneration` is the current in-progress version (on `releases/v0.42.0`).
...
### v0.42.0 — AI-assisted Companion authoring + regeneration, in progress (base branch `releases/v0.42.0`)
