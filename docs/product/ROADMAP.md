...
`v0.50.3 - Public Note Copy Flow & Related-Notes Consistency` is the current released version (on `releases/v0.50.3`, cut from `main` after v0.50.2 merged) — see its section below. No version is currently in progress.
