...
| SEO strategy remainder (P1 GSC setup, P3 exam-named Learn guides, P4 hub subject breakdown + full-inventory path, P5 ItemList JSON-LD, P6 organic-referrer analytics) | `seo-strategy-out/01-seo-strategy.md` | P1 is a non-code ops task (needs DNS/domain access); P3 needs human-verified exam-subject content, not to be fabricated; P4–P6 sized as a future content/feature release per Fable's own suggested sequencing | P1: domain access. P3: a curator who can write accurately about PNLE/LET/ALE structure. P4–P6: a scoping pass once P1's GSC data exists | 2026-07-17 |
| Public Library SEO expansion beyond the 3 Exam Hubs (broader/general-subject Google surfacing) | `public-library-seo-expansion-out/01-public-library-seo-expansion.md` | **Run — verdict: not now.** Broad general-subject SEO investment rejected (no curation machinery, unknown/thin depth, worse competitive field, dilutes topical authority). Real finding: same-day P2 vocabulary ship left every subject page — including 1-note/0-note ones — indexable with no depth filter, a genuine thin-content liability. Recommends N1 (indexation gate, `noindex` below a note threshold) after N2 (one SQL depth-inventory query) | N1/N2 not yet scoped — see next row | 2026-07-17 |
| N1/N2 — subject-page indexation gate + depth inventory (defensive follow-up from the SEO expansion verdict above) | same session | Not yet scoped | N2 (SQL depth query) first to set N1's note-count threshold, then N1 (small frontend PR: `noindex` + sitemap filter below threshold) | 2026-07-17 |
