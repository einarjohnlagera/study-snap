...
| Public Library SEO expansion beyond the 3 Exam Hubs (should NoteLib pursue broader/general-subject Google surfacing, e.g. "biology reviewer for grade school" — confirmed zero NoteLib results) | `public-library-seo-expansion-session-plan.md`, `public-library-seo-expansion-prompts/01-public-library-seo-expansion.txt` | Not yet run | user runs the Fable session, output lands in `public-library-seo-expansion-out/` | 2026-07-17 |
