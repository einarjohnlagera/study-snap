...
**Status: Ratified (2026-07-24).** Source: `company-redefinition-out/07-reprioritization.md`. **This is not Phase 3** — see the callout in that section for the precise distinction.
...
- Gate to enter: Phase 1 shipped (done). Does not depend on the Diagnostic Read's outcome — it helps under all three hypotheses above. Ratified 2026-07-24 — clear for `/kickoff` whenever scoped.
