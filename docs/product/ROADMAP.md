...
`v0.53.0 - SEO Discoverability: Exam Hub Depth & Organic Attribution` is the current released version (on `releases/v0.53.0`, cut from `main` after v0.52.1 merged) — see its section below.
