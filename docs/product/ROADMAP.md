...
| Production performance audit (Private Library, Public Library, Note Collection detail, Dashboard reported slow) | `production-performance-audit-session-plan.md`, `production-performance-audit-prompts/01-production-performance-audit.txt` | Not yet run | user runs the Fable session, output lands in `production-performance-audit-out/` | 2026-07-17 |
