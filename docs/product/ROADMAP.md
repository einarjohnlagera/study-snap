...
- **Multi-note Interview Practice** — pull questions across 2–3 notes from the same subject; requires the same multi-source generation context as Multi-note Long Exam (build that first, prove stability, then extend to Interview Practice)
