...
The goal is to support active recall and repeated practice through a calm, iterative learning workflow built around notes, practice questions, weak concepts, and adaptive review.
...
- supporting text should focus on summaries, key concepts, and practice quizzes rather than on AI tooling.
