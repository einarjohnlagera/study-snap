...
11. **Open questions awaiting your input:** (a) Explore's default tab — still unresolved three releases later; (b) within `v0.71.1`, whether an admin curating a learner's own note should be constrained, or whether row provenance needs recording — architectural, still open. **Settled, do not reopen:** the learner-depth question (2026-08-04 — notes own their depth; what remains is evolving authoring toward inference, a direction in `ADR-001`); **R4** (passed 2026-08-04 — it validated the Domain Context *value set*, **not** applicability, and must not be cited as settling anything about which programs a note applies to); and the four Program Family decisions (ratified 2026-08-05, shipped in Slice 3).
...
- ~~**`v0.71.0` Slice 3 — Program Family expansion.**~~ **No longer a gate — ratified 2026-08-05 and shipped in `v0.71.0`.** The four rulings are closed and binding; see the Slice 3 section above.
