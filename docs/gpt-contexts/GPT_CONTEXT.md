...
**⚠️ The "Target Audience hidden; backend saves X" rows above describe a field whose removal is under active proposal (2026-08-15, unratified).** Onboarding maps the learner's profile type onto the note's Target Audience, which is one reason the axis is ~99.3% predictable from other metadata. If you are asked about note taxonomy, read the proposal before treating Target Audience as permanent.
