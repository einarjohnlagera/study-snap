...
**Status:** **Accepted** — ratified by the owner 2026-08-03. Drafted, audited against production, and revised the same day; amended 2026-08-16 to ratify the four-axis model and gated Target Audience retirement; amended 2026-09-05 to correct the canonical-shapes table's copied-note row and to record the resolution of the overlapping-representation class.
**Deciders:** Owner
