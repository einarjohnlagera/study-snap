...
- `Save Learning Profile` updates `learnerLevel`, required `courseProgram`, and optional `bio`
- `Save Learning Profile` shows inline errors when either required field is missing
